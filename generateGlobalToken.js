...
//           user.position = allUsers.findIndex((u) => u._id.toString() === userId) + 1;
...
//     res.status(200).json({ message: "User positions and movements updated successfully." });
//   } catch (error) {
//     console.error("Error updating user positions and movements:", error);
//     res.status(500).json({ message: "Error updating user positions and movements." });
//   }
// });
